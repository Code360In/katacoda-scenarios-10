This scenario shows the control structures that are different in JavaScript, compared to Java or C++. You will learn about the two forms of for loops and the catch-everything clause.
